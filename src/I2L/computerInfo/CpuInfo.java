...
public class CpuInfo extends SigarCommandBase {
    ...
    public void output(String[] args, Computer comp) throws SigarException {
        ...
        comp.getProc().setProcessorVendor(info.getVendor());
        comp.getProc().setProcessorModel(info.getModel());
        comp.getProc().setProcessorMhz(Integer.toString(info.getMhz()));
        comp.getProc().setAvailableProcessors(Integer.toString(info.getTotalCores()));
